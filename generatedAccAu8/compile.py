...
os.system("g++ -g -o Host ./generatedSrc/Host.cpp  -L./CommLib/NetComm/src/ -lnetcomm -L./CryptoLib/src/ -lipe -lcryptorlib -L./CryptoLib/src/ -lssl -lcrypto -lpcap -lboost_serialization -L/usr/lib -libe -lpbc -lgmp")
